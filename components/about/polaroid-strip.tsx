...
const PHOTOS: Polaroid[] = [
  { id: "a", rotate: -8, label: "React", gradient: "from-cyan-400 to-blue-500" },
  { id: "b", rotate: 6, label: "Next.js", gradient: "from-gray-700 to-gray-900" },
  { id: "c", rotate: -4, label: "TypeScript", gradient: "from-blue-500 to-blue-700" },
  { id: "d", rotate: 7, label: "Tailwind", gradient: "from-teal-400 to-cyan-500" },
  { id: "e", rotate: -6, label: "Redux", gradient: "from-purple-500 to-purple-700" },
  { id: "f", rotate: 5, label: "Git", gradient: "from-orange-500 to-red-500" },
];
...
function PolaroidCard({
  ...
  return (
    ...
    >
      <div className={`relative h-full w-full overflow-hidden rounded-xl bg-linear-to-br ${photo.gradient} flex items-center justify-center`}>
        <span className="text-white font-semibold text-sm tracking-tight drop-shadow">
          {photo.label}
        </span>
      </div>
    </motion.div>
